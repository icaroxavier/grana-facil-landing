const faqs = [
  ...
  },
  {
    ...
    a: 'Planilha quebra com fórmula errada, não te avisa do que tá pra vencer, não importa CSV automaticamente, não tem dashboard. O Grana Fácil resolve essas dores e te economiza horas por mês. R$ 20/mês é o preço de um café por semana.',
  },
]
